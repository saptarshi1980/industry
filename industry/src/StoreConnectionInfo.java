...
public class StoreConnectionInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getSession().setAttribute("applicantFirstName", applicantFirstName.toUpperCase());
		request.getSession().setAttribute("applicantLastName", applicantLastName.toUpperCase());
		request.getSession().setAttribute("applicantAddress1", applicantAddress1.toUpperCase());
		request.getSession().setAttribute("applicantAddress2", applicantAddress2.toUpperCase());
		request.getSession().setAttribute("applicantPinCode", applicantPinCode.toUpperCase());
		request.getSession().setAttribute("applicantLandLine", applicantLandLine.toUpperCase());
		request.getSession().setAttribute("applicantMobile", applicantMobile.toUpperCase());
