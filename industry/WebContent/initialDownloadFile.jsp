...
<BR><BR>
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
        ...
        SELECT DATE_FORMAT(upload_date,'%d-%m-%Y') AS upload_date,head,file_path,"Download File" AS FILE,DATE_FORMAT(date_time,'%d-%m-%Y %H:%i:%s') AS date_time FROM upload_master WHERE DATE_FORMAT(upload_date,'%d-%m-%Y')='<%= date%>' ORDER BY date_time desc
